 ...
 */
declare function jwks(): Promise<NonNullablePaths<RawHttpResponse, `body` | `headers` | `headers.${number}.key` | `headers.${number}.value`, 4>>;
/**
 ...
 */
declare function userInfo(): Promise<NonNullablePaths<UserInfoResponse, `sub`, 2>>;
